...
import static com.gwintantuthuzelo.mylibrary.BookActivity.BOOK_ID_KEY;
...
//                Toast.makeText(mContext, holder.getAdapterPosition() + " Selected", Toast.LENGTH_SHORT).show();
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if (Utils.getInstance(mContext).removeFromAlreadyReady(books.get(position))) {
